...
import SendPasswordResetEmail from "./screens/SendPasswordResetEmail";
    ...
    <Router>
      <div className="App">
        ...
        <Switch>
          ...
          <Route path="/send-reset-password-email" component={SendPasswordResetEmail} />
          <Route path="/reset-password/:id/:token" component={ResetPassword} />
          <Route path="/verify-user/:id/:token" component={VerifyUser} />
